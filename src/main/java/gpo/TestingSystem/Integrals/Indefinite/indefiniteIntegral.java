...
public class indefiniteIntegral {
    ...
    public indefiniteIntegral(String integral,String variant1,String variant2,String variant3,String variant4)
    {
    ...
    {
        integral = CreateIntegral.integral();
        ...
        return new indefiniteIntegral(integral,variant1,variant2,variant3,variant4);
    }
